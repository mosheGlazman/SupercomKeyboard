...
import com.supercom.keyboard.latin.common.UnicodeSurrogate;
import com.supercom.keyboard.latin.settings.SpacingAndPunctuations;
import com.supercom.keyboard.latin.utils.CapsModeUtils;
import com.supercom.keyboard.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.supercom.keyboard.latin.common.Constants.UnicodeSurrogate
