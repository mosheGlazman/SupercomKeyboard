...
import com.supercom.keyboard.compat.MenuItemIconColorCompat;
...
import static com.supercom.keyboard.latin.settings.SingleLanguageSettingsFragment.LOCALE_BUNDLE_KEY;
                ...
                new OnMultiChoiceDialogAcceptListener() {
                    ...
                    public void onClick(boolean[] checkedItems) {
                        ...
                        for (int i = 0; i < checkedItems.length; i++) {
                            ...
                            String lang =  mUnusedLocaleValues[i];
