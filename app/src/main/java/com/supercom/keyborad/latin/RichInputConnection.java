...
import com.supercom.keyborad.latin.common.UnicodeSurrogate;
import com.supercom.keyborad.latin.settings.SpacingAndPunctuations;
import com.supercom.keyborad.latin.utils.CapsModeUtils;
import com.supercom.keyborad.latin.utils.DebugLogUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.supercom.keyborad.latin.common.Constants.UnicodeSurrogate
